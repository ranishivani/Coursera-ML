...
%a2' is (5000* 25)
a2 = [ones(m,1) a2'];% adding 1s (5000 * 26)
z3 = Theta2 * a2';% ( 10* 26) * ( 26 * 5000)
h_theta = sigmoid(z3); % h_theta equals a3

% y(k) - the great trick - we need to recode the labels (y given to us) as vectors containing only values 0 or 1 (page 5 of ex4.pdf)
